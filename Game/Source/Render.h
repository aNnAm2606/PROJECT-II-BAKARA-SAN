...
public:
	...
	bool DrawTextureScaled(SDL_Texture* texture, int x, int y, int width, int height, const SDL_Rect* section = NULL, bool useCamera = true, float speed = 1.0f, double angle = 0, int pivotX = INT_MAX, int pivotY = INT_MAX) const;
